    ...
    <div className="content-grid">
      ...
      <div className="flex flex-col justify-between gap-6 pt-[75px]">
        <div>
          ...
          <p className="text-[0.95rem] text-[#444] mt-3 mb-0 leading-relaxed">I'm a 20 years old college student. I enjoy learning new things, exploring new ideas, and challenging myself to grow every day. In my free time, I love dancing, watching K-dramas, traveling, and listening to music.</p>
        </div>
